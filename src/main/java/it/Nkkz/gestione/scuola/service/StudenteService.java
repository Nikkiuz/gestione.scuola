...
public class StudenteService {
	...
	private StudenteResponseDTO convertToResponseDTO(Studente studente) {
		...
		if (studente.getInsegnante() != null) {
			...
			dto.setInsegnanteNome(studente.getInsegnante().getNome()); // 🔥 Aggiunto
			dto.setInsegnanteCognome(studente.getInsegnante().getCognome()); // 🔥 Aggiunto
			System.out.println("📌 Insegnante assegnato nel DTO: " + studente.getInsegnante().getNome());
		} else {
			System.out.println("❌ Insegnante assente nella risposta!");
		}
